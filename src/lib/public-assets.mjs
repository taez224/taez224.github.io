...
import { BOOKS_PATH } from './books.mjs';
import { isImagePath } from './image-types.mjs';
import { indexByBasename } from './links.mjs';
import { isExcluded } from './publication.mjs';
import { normalize, walkIfPresent } from './vault-files.mjs';
...
export async function createAssetResolver({ vaultRoot, config, base }) {
  ...
  function resolve(sourcePath, rawTarget, { copy = true } = {}) {
