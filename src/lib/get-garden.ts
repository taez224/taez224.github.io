...
import { assembleGarden } from './garden.ts';
...
type Garden = Awaited<ReturnType<typeof assembleGarden>> & { config: import('./garden.ts').GardenConfig };
let pending: Promise<Garden> | null = null;
let assembledAt = 0;
