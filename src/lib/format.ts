...
export const GRAPH_COLORS: Record<string, string> = { AI: '#80698f', 개발: '#5d7897', 커리어: '#9a7852', 지식관리: '#5c806c', 글쓰기: '#9c6e6e', 철학: '#9b8a45', 조직: '#4a8791', 심리: '#a4617f', 소프트웨어공학: '#5d7897', 기타: '#817f72' };
