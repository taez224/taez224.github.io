...
export function selectGraphNodes({ candidates, edges, isEndpoint = () => false }: { candidates: ReadonlySet<string>; edges: readonly GraphEdge[]; isEndpoint?: (path: string) => boolean }) {
