...
export function renderSnapshotSvg(nodes, edges, positions, { width, height, font = 14, regionFont = 16, strokeWidth = 1.1, radiusScale = 1, label = '생각 지도' } = {}) {
  ...
  out += `<g data-regions="" opacity=".045">${regions.map((r) => `<path d="${regionPath(r.hull)}" fill="${topicColor(r.topic)}" stroke="${topicColor(r.topic)}" stroke-width="90" stroke-linejoin="round"></path>`).join('')}</g>`;
  ...
  out += `</g><g stroke="#9aab9d" stroke-width="${strokeWidth}" stroke-opacity=".16">`;
