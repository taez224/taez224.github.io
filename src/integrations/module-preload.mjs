...
export function withRenderBlocking(html, matches) {
...
export function withModulePreloads(html, hrefs) {
...
async function dependencyUrls(outputDir, entryUrls, cache) {
  const seen = new Set(entryUrls), order = [];
...
export default function modulePreload({ renderBlocking = [] } = {}) {
