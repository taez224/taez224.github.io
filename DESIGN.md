...
역할에 따라 제목 크기를 구분한다. 본문 H2/H3/H4는 26/21/17px, 목록 페이지 제목은 28px, 홈 절 제목과 지도 패널 제목은 24px다. 홈 대표 글 제목은 34px에서 모바일 24px로 바뀐다. 제목 아래 요약과 요약 콜아웃은 명조 18.5px/1.65다. 세부 굵기와 줄높이는 각 컴포넌트에 정의한다.
